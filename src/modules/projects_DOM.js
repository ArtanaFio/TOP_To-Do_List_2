import {
  ...
  makeDropDownOptions,
  makeNotAnOption,
} from "./DOM_basic_functions";

//supposed to handle everything in the left panel's project list
export function createPanelList(panel) {
  //, project, projectInterface, editFormInterface, projectDetails, convertDate, dateForInput, convertCalendarDate, editBackendProject
  const leftPanelContainer = panel;
  const panelList = makeElement(
    "ul",
    "project-list",
    "panel-list",
    "",
...
export function applyProjectSelectionStyling(
  parentContainer,
...
export function createProject(container, editFormInterface) {
  ...
  const projectButtonBox = makeElement(
    "div",
    "",
    "project-button-div",
    "",
  ...
  const titleAndLabelBox = makeElement(
    "div",
    "",
    "title-label-div",
    "",
  ...
  const projectTitle = makeElement(
    "h1",
    "",
    "project-title",
    "",
  ...
  const projectLabel = makeElement(
    "h4",
    "",
    "project-label",
    "LABEL",
  ...
  const mainPropertyBox = makeElement(
    "div",
    "",
    "all-property-div",
    "",
  ...
  const descriptionBox = makeElement(
    "div",
    "",
    "property-box",
    "",
  ...
  const descriptionHeader = makeElement(
    "h3",
    "",
    "property-header",
    "Description",
  ...
  const projectDescriptionModal = makeElement(
    "div",
    "",
    "description-modal gone",
    "",
    document.body
  );
  const projectDescriptionBox = makeElement(
    "div",
    "",
    "description-box",
    "",
  ...
  const projectDescriptionHeading = makeElement(
    "h3",
    "",
    "",
    "Description:",
  ...
  const projectDescription = makeElement(
    "p",
    "",
  ...
  const descriptionCloseButton = makeButton(
    "",
    "button",
    "cancel-button",
    "Close",
  ...
  const projectDueDate = makeElement(
    "p",
    "",
    "project-due-date project-p",
    "",
    dateBox
  );
  const priorityBox = makeElement(
    "div",
    "",
    "property-box",
    "",
  ...
  const priorityHeader = makeElement(
    "h3",
    "",
    "property-header",
    "Priority:",
  ...
  const projectPriority = makeElement(
    "p",
    "",
    "project-priority project-p",
    "",
    priorityBox
  );
  const taskBox = makeElement("div", "", "task-box", "", project);
  const taskAreaContainer = makeElement(
    "div",
    "",
    "task-area-container",
    "",
  ...
  const addTaskButton = makeButton(
    "",
    "button",
    "add-button",
    "Add Task",
  ...
  return {
    ...
    projectDescriptionModal: projectDescriptionModal,
    descriptionCloseButton: descriptionCloseButton,
  };
}
...
export function displayProjectList(
  ...
  if (projectDetails.description) {
    projectInterface.projectDescription.textContent =
    ...
    projectInterface.projectDescription.textContent =
      "This project wants to be mysterious";
  }

  if (projectDetails.dueDate) {
    projectInterface.projectDueDate.textContent = convertDate(
  ...
  if (projectDetails.label !== null) {
    ...
    projectInterface.projectLabel.classList.add("label-color");
    projectInterface.projectLabel.classList.remove("no-label-color");
  } else {
    projectInterface.projectLabel.textContent = "";
    projectInterface.projectLabel.classList.remove("label-color");
    projectInterface.projectLabel.classList.add("no-label-color");
  }
}

export function fillNewProjectList(
  projectInterface,
  projectDetails,
  titleCase,
  convertDate
...
export function createProjectEditForm(container) {
  ...
  const descriptionDiv = makeElement(
    "div",
    "",
    "form-property-div",
    "",
  ...
  const descriptionInput = makeInput(
    "textarea",
    "description",
    "",
    "description",
  ...
  const dueDateDropDownBox = makeInput(
    "input",
    "dueDate",
    "date",
    "dueDate",
  ...
  const formButtonBox = makeElement(
    "div",
    "",
    "form-button-box",
    "",
...
export function fillProjectEditForm(
  editFormInterface,
  projectDetails,
  dateForInput
) {
  ...
  if (projectDetails.dueDate !== null) {
    editFormInterface.dueDateDropDownBox.value = dateForInput(
      projectDetails.dueDate
    );
  } else {
...
export function editFrontendProject(
  projectInterface,
  editForm,
  titleCase,
  trim,
  ...
  projectInterface.projectTitle.textContent = titleCase(
    trim(editForm.titleInput.value)
  );
  projectInterface.projectDescription.textContent = sentenceCase(
    trim(editForm.descriptionInput.value)
  );
  if (convertCalendarDate(editForm.dueDateDropDownBox.value) !== "") {
    projectInterface.projectDueDate.textContent = convertCalendarDate(
      editForm.dueDateDropDownBox.value
    );
  } else {
...
export function createConfirmDeletionForm(container) {
  const module = makeElement("div", "", "transparent-box gone", "", container);
  const formContainer = makeElement(
    "div",
    "",
  ...
  const formLegendText = makeElement(
    "span",
    "",
    "",
...
export function displayDefaultFirst(
  display,
  projectInterface,
  project,
  convertDate,
  ...
  display(projectInterface, project, convertDate);

  project.tasks.forEach((task) => {
    applyTasks(projectInterface.taskArea, task, convertDate);
  });

  panelProject.classList.add("selected");
}
